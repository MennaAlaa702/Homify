...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layoutLandlordOnly = findViewById<LinearLayout>(R.id.layoutLandlordOnly)
        val logoutButton = findViewById<Button>(R.id.btnLogout)
        val btnEditPhoto = findViewById<ImageView>(R.id.fabEditPhoto)
        ...
        val userRole = sharedPref.getString("role", "tenant") // القيمة الافتراضية tenant
        ...
        logoutButton.setOnClickListener {
            ...
            val intent = Intent(this, TenantHome::class.java)
